  ...
  updateAllSenat: (kandidatOrder = 0) ->
    ...
    for obvodId, datum of @newSenat
      if @data.obvody[obvodId] isnt void
        ...
        datum.stranaObj = s
    @senatori.sort (a, b) ->
      | a.stranaObj.fallbackOrdering == 99 && b.stranaObj.fallbackOrdering != 99 => 1
      | b.stranaObj.fallbackOrdering == 99 && a.stranaObj.fallbackOrdering != 99 => -1
    ...
    @senatPopisky.selectAll "div.popisek"
      ..select \.content .html  ->
        l1 = if it.zkratka == "NEZ" or it.zkratka == "Nezávislí" then "Ostatní" else it.zkratka
        l2 = it.countNew + it.countOld
        "#{l1}<br>#{l2}"
